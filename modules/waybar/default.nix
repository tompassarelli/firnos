  ...
  config = lib.mkIf cfg.enable {
    ...
    home-manager.users.${username} = { config, ... }: {
      xdg.configFile = {
        ...
        ${"waybar/style.css"} = {
          source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/code/nixos-config/dotfiles/waybar/style.css";
        };
        ${"waybar/overview-waybar.py"} = {
          source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/code/nixos-config/dotfiles/waybar/overview-waybar.py";
        };
      };
